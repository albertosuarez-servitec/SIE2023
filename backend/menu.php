<?php
    ...
    $query = "SELECT menu.id_menu, menu.menu_destino, menu.menu_nombre, menu.menu_tiene_submenu, menu.menu_orden, menu.menu_activo, menu.menu_ruta, menu.menu_mostrar FROM menu ORDER BY  menu_orden ASC";
