<script>
    ...
    const editarRegistro = (id_perfilT,perfil_nombreT) => {
        id_perfil = id_perfilT
    ...
    const eliminarRegistro = async (id_perfilT,perfil_nombreT) => {
        id_perfil = id_perfilT
        perfil_nombre = perfil_nombreT
    ...
    // ORDEN
    const bajar = async (id_perfilT,menu_ordenT) => {
        try {
            spinner = true
    ...
    const subir = async (id_perfilT,menu_ordenT) => {
        try {
            spinner = true
            const rs = await axios.post(Lugar.backend+'cambiar_orden.php',{
                id_perfil: id_perfilT,
