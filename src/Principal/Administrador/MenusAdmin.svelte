        ...
        <div class="row">
            ...
            <div class="col-lg-2">
                <div class="input-group mb-3 barra-paginador bg-light">
                    <span class="input-group-text"><strong>Usuarios por página:</strong></span>
                ...
                <tbody >
                    {#if tieneRegistros}
                        {#each registros as registro}
                            {#if registro.numerus >= registroInicial && registro.numerus <= registroFinal}
                                <tr>
                                    <th scope="row">{registro.numerus}</th>
                                    <td ></td>
                                </tr>   
                            {/if}
                        {/each}
